...
base=Path('C:/Users/EASY acadêmico/Documents/demo/recuperados/data/P09')
...
for task in csv.DictReader((base/'resumo_tarefas.csv').open(encoding='utf-8-sig')):
 ...
 fixes=list(csv.DictReader((base/f"Fixations P09 {task['TarefaReal']}.csv").open()))
...
Path('tmp/checagem_p09_gaps.json').write_text(json.dumps(report,indent=2,ensure_ascii=False),encoding='utf-8')
